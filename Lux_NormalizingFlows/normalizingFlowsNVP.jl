...
# ╔═╡ 10d6cf0c-1149-11f0-2907-8ffc3a13e2c6
begin
...
# ╔═╡ b4598b1f-5c40-4999-80c4-c6e270c09e82
function make_moons(
    rng::AbstractRNG,
    ::Type{T},
    n_samples::Int=100;
...
# ╔═╡ 0f1b5590-d01c-4d28-8a2c-fd8823345084
begin
    fig = Figure()
...
# ╔═╡ b756d3f6-d60d-4435-8ec3-fbae35ae693f
...
# ╔═╡ 4be9a481-2377-4aa7-abce-19c59827f8b6
begin
...
# ╔═╡ ad578977-5382-4dc5-aa0e-bec44d515113
begin
...
# ╔═╡ 6b0edc90-3529-455d-a95f-510b76f86a3d
begin
...
# ╔═╡ 73f75e42-b072-4072-90c6-1730616c0bf2
begin
	function main(;
    maxiters::Int=10_000,
...
trained_model = main(maxiters=100_000)
end

# ╔═╡ 2e76522b-2a93-43a1-9703-2c2b4da03fd6
begin 
...
begin
    finalfig = Figure(; size=(1200, 800))

    for (idx, z) in enumerate(z_stages)
        i, j = (idx - 1) ÷ 3, (idx - 1) % 3
        ax = Axis(finalfig[i, j]; title="$(idx) transforms")
        scatter!(ax, z[1, :], z[2, :]; markersize=2)
    end
...
manifest_format = "2.0"
project_hash = "34c0a98fb9e052d82fc2391ce0614de18c7d911b"
...
git-tree-sha1 = "aa473e6eda6f442317cda8039b5c5a324241fe4c"
...
git-tree-sha1 = "58425c34dd82a5ee5d8fe9cf996cd5f43a26b85a"
...
git-tree-sha1 = "37dc4c73f361dbaae35c677c5a74189a24576e53"
...
[[deps.Reactant]]
deps = ["Adapt", "CEnum", "Downloads", "EnumX", "Enzyme", "EnzymeCore", "Functors", "GPUArraysCore", "HTTP", "LLVMOpenMP_jll", "Libdl", "LinearAlgebra", "OrderedCollections", "PrecompileTools", "Preferences", "Random", "ReactantCore", "Reactant_jll", "ScopedValues", "Scratch", "Sockets"]
git-tree-sha1 = "e1a8d2b92ce893ec654b1a23513ebccbb66211bb"
...
git-tree-sha1 = "9189b6f86857f548a8981c99cc5e0df01baeb6cf"
uuid = "a3311ec8-5e00-46d5-b541-4f83e724a433"
version = "0.1.9"

[[deps.Reactant_jll]]
deps = ["Artifacts", "CUDA_Driver_jll", "JLLWrappers", "LazyArtifacts", "Libdl", "TOML"]
git-tree-sha1 = "c088da6662d8896c6061b1ecd12ddb43e04065dc"
